...
def churn_app_events():
  return (
    spark.readStream.format("cloudFiles")
      ...
      .load("/Volumes/caprica_us_east_1_7474643855042493/dbdemos_retail_c360/c360/events"))
...
def churn_orders_bronze():
  return (
    spark.readStream.format("cloudFiles")
      ...
      .option("cloudFiles.inferColumnTypes", "true")
      .load("/Volumes/caprica_us_east_1_7474643855042493/dbdemos_retail_c360/c360/orders"))
...
def churn_users_bronze():
  return (
    spark.readStream.format("cloudFiles")
      .option("cloudFiles.format", "json")
      .option("cloudFiles.inferColumnTypes", "true")
      .load("/Volumes/caprica_us_east_1_7474643855042493/dbdemos_retail_c360/c360/users"))
