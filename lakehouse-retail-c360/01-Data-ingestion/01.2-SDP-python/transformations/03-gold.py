...
#                                                                                   Model name               |
#                                                                                       |                    |
predict_churn_udf = mlflow.pyfunc.spark_udf(spark, "models:/caprica_us_east_1_7474643855042493.dbdemos_retail_c360.dbdemos_customer_churn@prod", "long", env_manager='virtualenv')
